            ...
            ZStack {
                ...
                VStack {
                    ...
                    if !viewModel.team1Name.isEmpty || !viewModel.team2Name.isEmpty {
                        Text(isPlayerOne ? viewModel.team1Name.prefix(12) : viewModel.team1Name.prefix(12))
...
struct TallyButton_Previews: PreviewProvider {
    ...
    static let viewModel2 = GameViewModel(serveLimit: 5, scoreLimit: 11, player1Color: .red, player2Color: .blue)
